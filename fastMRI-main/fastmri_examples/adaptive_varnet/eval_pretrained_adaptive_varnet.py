...
def load_model(
    ...
    torch.save(module.varnet.sens_net.state_dict(), 'D:/Users/user/snu/fastmri/pretrained/sens_net.pt')
...
def cli_main(args):
    ...
    try:
        ...
        args.load_checkpoint = 'D:/Users/user/snu/fastmri/pretrained/adaptive_4x.ckpt'
